...
import { Plus, List, Check, ArrowDownRight, SquarePen, Trash, ListChecks, Sigma } from 'lucide-react';
        ...
        <CardContent>
          ...
          <div className="mt-4 border-b">
            <div className="h-12 flex justify-between items-center border-t">
              <div className="w-1.5 h-full rounded-tr-md rounded-br-md bg-green-300"></div>
